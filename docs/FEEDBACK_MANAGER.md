...
- [ComputeShaderManager.js](https://github.com/Amirashkan/rhizomium/blob/main/src/gpu/ComputeShaderManager.js) - Low-level compute shader wrapper
- [ComputeNodes.js](https://github.com/Amirashkan/rhizomium/blob/main/src/data/nodes/ComputeNodes.js) - Compute node definitions
